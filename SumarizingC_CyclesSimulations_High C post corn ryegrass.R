...
setwd("C:/Felipe/OrganicTransitions_N2OROSE/CyclesSimulation/RoseRCodeScripts/SumarizingC_CyclesSimulations/ROSE Simulation Work/High C post corn ryegrass") ;

# Create a directory for sumarizing outputs

# dir.create()

Scenario.name<-"High C post corn ryegrass"
...
writeWorksheetToFile("../OutputSummary/Summary.xlsx",Summary.Rotation, sheet="High C post corn ryegrass" )      ; 
